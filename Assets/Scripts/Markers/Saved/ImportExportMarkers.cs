...
public class ImportExportMarkers : ImportExportJSON<MarkerData>
{
    ...
    private void TryImportWithDummyData()
    {
        List<MarkerData> markersList = new List<MarkerData>
        {
            ...
            //new MarkerData(true, "AQRCode_2", new Vector3(3.61f, 0, 0), Quaternion.Euler(180,0,0)) // QR is inversed
            // fast-slow-still - adapt to my physical space.
            new MarkerData(true, "AQRCode_2", new Vector3(-2.0f, 0, 0), Quaternion.Euler(180,0,0)) // QR is inversed
        };
